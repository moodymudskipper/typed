...
The created function will be the following, we see that `Character(1) ? msg <- "Working hard"`
...
`declare` calls however are very explicit.
...
great efforts on static typing, assertions, or annotations in R.
