...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/moodymudskipper/typed.svg?branch=master)](https://travis-ci.com/moodymudskipper/typed)
<!-- badges: end -->
...
If we want to use more than the first argument, we can use `purrr::partial()` :
...
but to give it a type checker on the left hand side. It will ultimately create
